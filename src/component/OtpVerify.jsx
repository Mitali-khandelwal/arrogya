...
width: '100%' ,
fontSize: '20px' , 
marginBottom: '50px'}}>Enter the OTP that has been sent to your Mobile/E-mail </Box>

<Box sx={{display:'flex',justifyContent:'center'}}><MuiOtpInput sx={{width:'250px'}} TextFieldsProps={{variant:'standard'}}/></Box>

         
</Box>
<Box sx={{display:'flex',justifyContent:'center'}}>
<Button variant="contained" sx={{width:"50%",fontWeight:'600',fontSize:'24px',borderRadius:'30px'}}>Verify Otp</Button>
